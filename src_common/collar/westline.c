/**
 * DOC: -- westline.c -- finds border between map and west collar
 * Peter Thompson 2020
 *
 * Algorithm:
 *
...
/**
 * westline() - find west edge of map
 ...
 * Return: y pixel of west edge of map
 *         -1 if no edge found
 */
int westline(uint8_t *array, int mapavg, int collaravg, int width, int height,
             mapset *mapsetnow) {
